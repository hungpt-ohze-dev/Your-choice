      ...
      //  [SerializeField]
       ...
       // [SerializeField]
        ...
        private IEnumerator StartC()
        {
            ...
            if (balanceAmountText) balanceTween = new TweenIntValue(balanceAmountText.gameObject, MPlayer.Coins, 1, 2, true, (b) => { if (this && balanceAmountText) balanceAmountText.text = (b > 0) ? b.ToString(coinsFormat) : "0"; });
            if (WinAmountText) winCoinsTween = new TweenIntValue(WinAmountText.gameObject, 0, 0.5f, 2, true, (w) => { if (this && balanceAmountText) WinAmountText.text = (w > 0) ? w.ToString(coinsFormat) : "0"; });
